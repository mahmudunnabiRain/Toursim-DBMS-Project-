            ...
            <div class="main">
                ...
                <div class="logo_and_general_info">
                    ...
                    <div class="general_info">
                        ...
                        <a class="infos" style="background-color:black; border:1px solid crimson" >Tourguide Account</a>
                        <a class="infos">
                            <?php
                    ...
                    <div class = "add_gig">
                        <form class="form_add_gig" action="add_gig.php" enctype="multipart/form-data" method="post">
                            <a class="msg">Add new gig</a>
                            place:<input class="add_gig_input" type="text" name="_place" required autocomplete="off"/>
                            price per day:<input class="add_gig_input" type="number" name="_price" required autocomplete="off"/>
                        ...
                        <a class="msg_2">Your gigs</a>
                            <ul>
                                <?php
                                    ...
                                    $sql = "SELECT tg_id, tg_place, tg_price, tg_description, tg_image FROM tourguide_table WHERE tg_sp_id='".$_SESSION['sp_id']."' ";
                                    $result = $conn->query($sql) or die("result error");
                                    $data[] = "";
                                    if(mysqli_num_rows($result) > 0 )
                                        {
                                                ...
                                                echo "
                                                    ...
                                                    <div class='gig'>
                                                        <div style='display:inline-block;'>
                                                            <div class='gig_img'>
                                                                <img width='150px' height='75px' src='.//gig_image/".$data['tg_image']."'> 
                                                            </div>
                                                            <a class='gig_data'>place: ".$data['tg_place']."</a><br>
                                                            <a class='gig_data'>daily price: ".$data['tg_price']."</a><br><br>
                                                            <a class='gig_data'>description:</a><br>
                                                            <a class='gig_data'>".$data['tg_description']."</a>
                                                        ...
                                                        <a class='remove_button' href='remove_gig.php?tg_id=".$data['tg_id']."'>Remove</a>
                                                    </div> 
                                                    ";
                                            }
                        ...
                        <a class="msg_2">Bookings</a>
                            <ul>
                                <?php
                                    ...
                                    $sql = "SELECT tourist_name, tb_id, tb_paid, tb_place, tb_price, tb_done, tb_fromdate, tb_todate, tb_tourist_id FROM tourguide_booking_table, tourist_table WHERE tb_sp_id='".$_SESSION['sp_id']."' AND tb_tourist_id = tourist_id ";
                                    $result = $conn->query($sql) or die("result error");
                                    $data[] = "";
                                    if(mysqli_num_rows($result) > 0 )
                                        {
                                                ...
                                                echo "
                                                    ...
                                                    <div class='gig'>
                                                        <div style='display:inline-block;'>
                                                            ...
                                                            <a class='gig_data'>toursit_id: ".$data['tb_tourist_id']."</a><br>
                                                            <a class='gig_data'>tourist_name: ".$data['tourist_name']."</a><br>
                                                            <a class='gig_data'>price: ".$data['tb_price']."</a><br>
                                                            <a class='gig_data'>service provided: ".$data['tb_done']."</a><br>
                                                            <a class='gig_data'>payment recieved: ".$data['tb_paid']."</a><br>
                                                        </div>
                                                        <style>
                                                            .remove_button:hover{
                                                                background-color: crimson;
